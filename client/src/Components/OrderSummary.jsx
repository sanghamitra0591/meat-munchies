...
export const OrderSummary = () => (<Stack spacing={{ base: '6', md: '10' }}>
    ...
    <Stack spacing="8">
      ...
      <HStack spacing="6">
        <Input name="discount" placeholder="Discount Code" focusBorderColor={useColorModeValue('blue.500', 'blue.200')} bg={useColorModeValue('white', 'gray.700')} size="lg"/>
        <Button size="lg" px="8" bg={useColorModeValue('gray.500', 'gray.600')} _hover={{ bg: useColorModeValue('gray.600', 'gray.500') }} _active={{ bg: useColorModeValue('gray.700', 'gray.500') }} color="white">
          Apply
        </Button>
      </HStack>
      <Stack spacing="6">
    ...
    <Stack spacing="8">
      ...
      <Stack spacing="3">
        ...
        <HStack spacing="8" color={useColorModeValue('blue.500', 'blue.200')} fontWeight="semibold">
          <HStack>
