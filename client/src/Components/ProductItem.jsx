...
export const ProductItem = (props) => {
    const { product } = props;
    return (<Flex justify="space-between" key={product.id}>
      <Stack direction="row" spacing="5">
        ...
        <Stack spacing="3">
          ...
          <Select aria-label="Select quantity" maxW="16" size="sm" borderRadius="md" focusBorderColor={useColorModeValue('blue.500', 'blue.200')} bg={useColorModeValue('white', 'gray.700')}>
            <option>1</option>
            <option>2</option>
            <option>3</option>
          </Select>
