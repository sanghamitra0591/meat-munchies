import { Box, Center, FormControl, FormLabel, Heading, HStack, Input, Radio, RadioGroup, Select, Stack, Text, useColorModeValue, } from '@chakra-ui/react';
import * as React from 'react';
import { GooglePayLogo, MasterCardLogo, PayPalLogo, VisaLogo } from './Logos';
export const PaymentInformation = () => (<Stack spacing={{ base: '6', md: '10' }}>
      ...
      <Stack direction={{ base: 'column', lg: 'row' }} spacing="6">
        <Radio defaultChecked spacing="3" flex="1">
          <Stack spacing="1.5">
            ...
            <HStack>
              <Center borderWidth="1px" width="8" height="5" bg={useColorModeValue('transparent', 'gray.50')} borderColor={useColorModeValue('gray.300', 'gray.50')} borderRadius="base">
                <VisaLogo />
              </Center>
              <Center borderWidth="1px" width="8" height="5" bg={useColorModeValue('transparent', 'gray.50')} borderColor={useColorModeValue('gray.300', 'gray.50')} borderRadius="base">
                <MasterCardLogo />
    ...
    <Stack spacing="8">
      <Stack direction="row" spacing="6">
        <FormControl id="card-number">
          ...
          <Input name="card-number" placeholder="Card number" focusBorderColor={useColorModeValue('blue.500', 'blue.200')}/>
        </FormControl>
        <FormControl id="card-name">
          <FormLabel color={useColorModeValue('gray.700', 'gray.200')}>Name on card</FormLabel>
          <Input name="card-name" placeholder="Card name" focusBorderColor={useColorModeValue('blue.500', 'blue.200')}/>
        </FormControl>
      </Stack>
      <HStack spacing="6">
        ...
        <FormControl id="card-cvc">
          ...
          <Input name="card-cvc" placeholder="CVC" focusBorderColor={useColorModeValue('blue.500', 'blue.200')}/>
        </FormControl>
      </HStack>
    </Stack>
  </Stack>);
